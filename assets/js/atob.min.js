 ...
 */
document.addEventListener("DOMContentLoaded",function(){for(var t=document.querySelectorAll("[data-atob]"),e=0;e<t.length;++e)t[e].innerHTML=atob(t[e].innerHTML),t[e].removeAttribute("data-atob")});
